...
tasks = []
# url_template = "https://top.chinaz.com/hangye/index_zonghe_luntan_2.html"
url_template = "https://top.chinaz.com/hangye/index_zonghe_luntan_{}.html"
            ...
            try:
                ...
                async with session.get(url, headers=headers) as response:
                    ...
                    for item in items:
                        ...
                        es.index(index="chinaz_luntan", doc_type="chinaz_luntan", id=_id, body=data)
...
async def create_task(start, end):
    ...
    for i in range(start, end):
        if i == 1:
            url = 'https://top.chinaz.com/hangye/index_zonghe_luntan.html'
        else:
