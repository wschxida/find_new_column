...
tasks = []
# url_template = "https://top.chinaz.com/hangye/index_news_2.html"
url_template = "https://top.chinaz.com/hangye/index_news_{}.html"
            ...
            try:
                ...
                async with session.get(url, headers=headers) as response:
                    ...
                    for item in items:
                        ...
                        es.index(index="chinaz_news", doc_type="chinaz_news", id=_id, body=data)
...
async def create_task(start, end):
    ...
    for i in range(start, end):
        if i == 1:
            url = 'https://top.chinaz.com/hangye/index_news.html'
        else:
