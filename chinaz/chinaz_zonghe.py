...
# url_template = "https://top.chinaz.com/hangye/index_zonghe_difang_{}.html"
# url_template = "https://top.chinaz.com/hangye/index_zonghe_falu_{}.html"
# url_template = "https://top.chinaz.com/hangye/index_zonghe_tuanti_{}.html"
# url_template = "https://top.chinaz.com/hangye/index_zonghe_menhu_{}.html"


url_template = "https://top.chinaz.com/hangye/index_zonghe_boke_{}.html"
            ...
            try:
                ...
                async with session.get(url, headers=headers) as response:
                    ...
                    for item in items:
                        ...
                        es.index(index="chinaz_zonghe", doc_type="chinaz_zonghe", id=_id, body=data)
...
async def create_task(start, end):
    ...
    for i in range(start, end):
        if i == 1:
            url = 'https://top.chinaz.com/hangye/index_zonghe_boke.html'
        else:
