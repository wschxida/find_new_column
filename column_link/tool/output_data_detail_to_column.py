...
def main():
    ...
    select_column = f"select ad.Article_URL, ad.Domain_Code, ad.Article_Source from article_detail ad " \
                    f"where 1=1 and ad.Website_No in (select Website_No from website where Website_Name like'%百度新闻%') " \
                    f"and ad.Extracted_Time>'2020-07-01' and ad.Extracted_Time<'2020-08-01' " \
                    f"and Article_Source is not NULL and Article_Source !='' GROUP BY Domain_Code;"
