...
def run():
    ...
    select_column = f"select ListPage_URL,ListPage_Title from listpage_url where Website_No IN (select Website_No from website where Website_Name like'%百家号%') and ListPage_URL like'https://baijiahao.baidu.com/u?app_id=%';"
    try:
